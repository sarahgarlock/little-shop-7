...
RSpec.describe Merchant, type: :model do
  ...
  describe 'instance methods' do
    ...
    describe '.top_by_revenue' do
      it 'joins invoices and invoice_items' do
        ...
        transaction_1 = invoice_1.transactions.create!(result: 1)
        transaction_2 = invoice_2.transactions.create!(result: 1)
        transaction_3 = invoice_3.transactions.create!(result: 1)
        ...
        expect(merchants.to_a).to eq([merchant_3, merchant_4, merchant_2, merchant_6, merchant_5])
        expect(merchants.to_a).to_not include([merchant_1])
